    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{ paddingTop: "12rem", textAlign: "center" }}
        >
          <h1 style={{ fontSize: "3rem", marginBottom: "2rem" }}>
            Your Cart is Empty
          </h1>
          <Link href="/bookstore">
            <Button size="lg">Explore Bookstore</Button>
          </Link>
        </div>
      </main>
    );
                ...
                >
                  ...
                  >
                    <Input
                      ...
                      onChange={(val) => {
                        setAddress({ ...address, first_name: val });
                        if (errors["ship-first"])
                          setErrors({ ...errors, "ship-first": null });
                      }}
                    ...
                    <Input
                      ...
                      onChange={(val) => {
                        setAddress({ ...address, last_name: val });
                        if (errors["ship-last"])
                          setErrors({ ...errors, "ship-last": null });
                      }}
                  ...
                  <Input
                    ...
                    onChange={(val) => {
                      ...
                      if (errors["ship-email"])
                        setErrors({ ...errors, "ship-email": null });
                    }}
                  ...
                  <Input
                    ...
                    onChange={(val) => {
                      ...
                      if (errors["ship-phone"])
                        setErrors({ ...errors, "ship-phone": null });
                    }}
                  ...
                  <Input
                    ...
                    onChange={(val) => {
                      setAddress({ ...address, street1: val });
                      if (errors["ship-addr1"])
                        setErrors({ ...errors, "ship-addr1": null });
                    }}
                  ...
                  >
                    <Input
                      ...
                      onChange={(val) => {
                        ...
                        if (errors["ship-city"])
                          setErrors({ ...errors, "ship-city": null });
                      }}
                    ...
                    <Input
                      ...
                      onChange={(val) => {
                        setAddress({ ...address, state_code: val });
                        if (errors["ship-state"])
                          setErrors({ ...errors, "ship-state": null });
                      }}
                    ...
                    <Input
                      ...
                      onChange={(val) => {
                        setAddress({ ...address, postcode: val });
                        if (errors["ship-zip"])
                          setErrors({ ...errors, "ship-zip": null });
                      }}
                  ...
                  <SelectInput
                    ...
                    onChange={(val) =>
                      setAddress({ ...address, country_code: val })
                    }
                    options={["US", "GB", "CA", "AU", "DE", "FR", "IN"]}
                  />
            ...
            >
              ...
              >
                ...
                <div style={{ marginBottom: "2.5rem" }}>
                  ...
                  >
                    Please complete your payment via PayPal to finalize your
                    order.
                  </p>
      ...
      {isPlacingOrder && (
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "1.1rem" }}>
            Securing your print-on-demand job with Lulu...
          </p>
          <style>{`
  ...
  return (
    <div
      style={{
        width: "80px",
        height: "2px",
        background: active ? "var(--primary-color)" : "var(--border-medium)",
    ...
    >
      ...
      <input
        ...
        style={{
          ...
          border: `1px solid ${error ? "#ff4d4d" : "var(--border-medium)"}`,
          padding: "1rem 1.2rem",
          borderRadius: "12px",
          color: "var(--text-main)",
          outline: "none",
  ...
  return (
    ...
    >
      ...
      >
        {cart.map((item) => (
          <div
            key={`${item.id}-${item.format || "unknown"}`}
            style={{
              display: "flex",
          ...
          >
            <span
              style={{ color: "var(--text-muted)", flex: 1, lineHeight: "1.4" }}
            >
              {item.title}{" "}
              {item.format && (
                <span
